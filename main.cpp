...
int main() {
    ...
    std::cout << "=== Демонстрация работы с циклическим двусвязным списком ===\n\n";

    // 1. Конструктор со списком инициализации
    std::cout << "1. Конструктор со списком инициализации:\n";
    CircularDoublyLinkedList<int> list1 = { 10, 20, 30, 40, 50 };
    ...
    CircularDoublyLinkedList<int> list3(std::move(list2));
    ...
    CircularDoublyLinkedList<int> emptyList;
    ...
    // 13. Демонстрация цикличности (особенность циклического списка)
    std::cout << "13. Демонстрация цикличности (обходим 10 элементов):\n";
    CircularDoublyLinkedList<int> cyclicList = { 1, 2, 3 };
    std::cout << "Список: " << cyclicList << "\n";
    std::cout << "Циклический обход: ";
    Node<int>* node = cyclicList.getHead();
    for (int i = 0; i < 10; ++i) {
        std::cout << node->data;
        if (i < 9) std::cout << " → ";
        node = node->next;
